        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              child: Column(
                children: [
                  buildProductCard2('A Noiva                      `', 'Ali Hazelwood', 46.30, '4,6', '/melhorespara0.jpg', context),
                  const SizedBox(height: 24),
                  buildProductCard2('Judas                        `', 'J. R. R. Tolkien', 59.90, '4,8', '/melhorespara1.jpg', context),
                  const SizedBox(height: 24),
                  buildProductCard2('Sobre desistir               `', 'Adam Phillips', 51.66, '4,5', '/melhorespara2.jpg', context),
                  const SizedBox(height: 24),
                  buildProductCard2('Leve minha alma              `', 'Harley Laroux', 47.50, '4,6', '/melhorespara3.jpg', context),
                  const SizedBox(height: 24),
                  buildProductCard2('Box Tudo pelo jogo', 'Nora Sakavic', 129.90, '4,7', '/melhorespara4.jpg', context),
                  const SizedBox(height: 24),
                  buildProductCard2('Fisgados                     `', 'Emily McIntire', 43.39, '4,5', '/melhorespara5.jpg', context),
                  const SizedBox(height: 24),
                  buildProductCard2('Under Your Skin              `', 'Zoe X', 48.00, '4,7', '/melhorespara6.jpg', context),
                  const SizedBox(height: 24),
                  buildProductCard2('A lista de convidados', 'Lucy Foley', 49.28, '4,8', '/melhorespara7.jpg', context),
                ],
              ),
            ),
            Padding(
