...
import 'package:loja/database/user_database.dart';
import 'package:loja/model/user_model.dart';
import 'package:loja/userInterface/pages/loja.dart';
...
class UserController  {
  ...
  void login(context, String email, String senha){
    ...
    if(result.isNotEmpty){
      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_)=> Loja(index: index)), (route) => false, );
    }else{
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          backgroundColor: Color(0xFFE5543C),
